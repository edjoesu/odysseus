...
class MyQTToolbar(NavigationToolbar2QT):
    ...
    def _init_toolbar(self):
        ...
        toolitems = (
            ...
            ('Ncount ROI', 'Set Ncount ROI', ':/roi_ncount.svg',
             self.set_roi, True),
            ('Noatom ROI', 'Set Noatom ROI', ':/roi_ncount.svg',
             self.set_roi, True),
            None,
        ...
        self._activenames = ['ZOOM', 'Analysis ROI', 'Ncount ROI', 'Noatom ROI']
    ...
    def set_roi(self, *args):
        ...
        if self.sender() is self.actions['Analysis ROI']:
            ...
            roiname = 'Ncount ROI'
        elif self.sender() is self.actions['Noatom ROI']:
            roiname = 'Noatom ROI'
    ...
    def release_roi(self, event):
        ...
        for cur_xypress in self._xypress:
            ...
            elif self._active == 'Noatom ROI':
                self.canvas.rois['noatom'] = roi
                self.canvas.drawROI('noatom')
            else:
                pass
...
class MyMplCanvas(FigureCanvas):
    ...
    def __init__(self, parent=None, img=np.ones((576, 384))*1.2, \
        ...
        self.rois = {'ncount':None, 'analysis':None, 'noatom':None}
        self.roiboxes = {'ncount':None, 'analysis':None, 'noatom':None}
        self.roicols = {'ncount':coldict['purple'], 'analysis':coldict['blue'], 'noatom':coldict['orange']}
        self.marker = None
...
class PngWidget(QWidget):
    ...
    def update(self, pngimg, datapath, ncount):
        ...
        if pngimg:
            ...
            self.img.setPixmap(QPixmap(pngimg))
            self.ncount.setText('N = %1.4fm'%(ncount*1e-6))
